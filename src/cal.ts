let all_btns = document.querySelectorAll("button") as NodeListOf<HTMLButtonElement>;
let final_ans = document.getElementById("screen_result") as HTMLElement;
let display = document.getElementById("screen") as HTMLElement;

// define a type for number or string value:

type NumberOrString = string | number;

let temp: NumberOrString;
let curr_dis_val: NumberOrString;
let memory: string;
...
for (let items of all_btns) {
    items.addEventListener("click", (e) => {
        ...
        let btn_val: NumberOrString = (e.target as HTMLInputElement).innerText;
        ...
        switch (btn_val) {
            ...
            case "10𝑥":
                display.innerText = (10 ** eval(display.innerText)).toString();
                break;
